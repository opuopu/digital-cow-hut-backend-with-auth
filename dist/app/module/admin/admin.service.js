...
const loginadmin = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ispasswordMatched = admins.isPassWordMatched(password, isUserExist.password);
    if (!ispasswordMatched) {
        throw new handleapiError_1.default(http_status_1.default.UNAUTHORIZED, 'password is incorrect');
    }
    const getadmin = yield admin_model_1.default.findOne({ phoneNumber: phoneNumber }, { _id: 1 });
    if (!getadmin) {
        throw new handleapiError_1.default(http_status_1.default.NOT_FOUND, 'admin not found');
    }
    // accessToken
    const accessToken = jwthelper_1.default.createToken({ id: getadmin.id, role: role }, config_1.default.jwt.secret, {
        expiresIn: config_1.default.jwt.jwt_expires_in,
    });
    const refreshToken = jwthelper_1.default.createToken({ id: getadmin.id, role: role }, config_1.default.jwt.secret, {
        expiresIn: config_1.default.jwt.jwt_expires_in,
    });
    return {
        accessToken,
