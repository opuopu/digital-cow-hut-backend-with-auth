...
const createcow = (0, catchasync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield cow_service_1.default.createAcow(req.body, req.user);
    res.send({
        success: true,
        statusCode: 200,
...
const getallcows = (0, catchasync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(req.query, cow_constant_1.filterableField);
    const paginationOptions = (0, pick_1.default)(req.query, cow_constant_1.items);
    const result = yield cow_service_1.default.getAllcows(filters, paginationOptions);
    res.send({
        success: true,
        statusCode: 200,
        meta: result.meta,
...
const deletecow = (0, catchasync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const result = yield cow_service_1.default.deleteCow(req.params.id, user);
    res.send({
        success: true,
        statusCode: 200,
...
const updatecow = (0, catchasync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const result = yield cow_service_1.default.updateCow(req.params.id, req.body, user);
    res.send({
        success: true,
        statusCode: 200,
