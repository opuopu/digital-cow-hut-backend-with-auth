...
const getAllcows = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip, sortOrder, sortBy } = (0,
    paginationHelper_1.default)(paginationOptions)
    const filter = {}
    const { searchTerm } = filters,
      fields = __rest(filters, ['searchTerm'])
    if (fields.minPrice) {
      filter.price = { $gte: Number(fields.minPrice) }
    }
    if (fields.maxPrice) {
      filter.price = Object.assign(Object.assign({}, filter.price), {
...
//   patch cow
const updateCow = (id, payload, user) =>
  __awaiter(void 0, void 0, void 0, function* () {
